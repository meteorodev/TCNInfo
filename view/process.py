...
preci="/media/drosero/Darwin/Mensuales/TMax/RCP45/tasmax_day_Ecuador_IPSL-CM5A-MR_rcp45_"
####periodo 2011-2030
pr=Process(preci)
data=pr.procesPeriod(2011,2030,var='tmax',funcion=2)
data.to_csv(guar+"tmax_2011-2030rcp45.csv", sep=";", index=False, encoding="utf-8")
####periodo 2031-2050
data=pr.procesPeriod(2031,2050,var='tmax',funcion=2)
data.to_csv(guar+"tmax_2031-2050rcp45.csv", sep=";", index=False, encoding="utf-8")
####periodo 2051-2070
data=pr.procesPeriod(2051,2070,var='tmax',funcion=2)
...
preci="/media/drosero/Darwin/Mensuales/TMin/RCP45/tasmin_day_Ecuador_IPSL-CM5A-MR_rcp45_"
####periodo 2011-2030
pr=Process(preci)
data=pr.procesPeriod(2011,2030,var='tmin',funcion=2)
data.to_csv(guar+"tmin_2011-2030rcp45.csv", sep=";", index=False, encoding="utf-8")
####periodo 2031-2050
data=pr.procesPeriod(2031,2050,var='tmin',funcion=2)
data.to_csv(guar+"tmin_2031-2050rcp45.csv", sep=";", index=False, encoding="utf-8")
####periodo 2051-2070
data=pr.procesPeriod(2051,2070,var='tmin',funcion=2)
data.to_csv(guar+"tmin_2051-2070rcp45.csv", sep=";", index=False, encoding="utf-8")
####Datos de temperatura minima con rcp 85
preci="/media/drosero/Darwin/Mensuales/TMin/RCP85/tasmin_day_Ecuador_IPSL-CM5A-MR_rcp85_"
####periodo 2011-2030
pr=Process(preci)
data=pr.procesPeriod(2011,2030,var='tmin',funcion=2)
...
preci="/media/drosero/Darwin/Mensuales/TMed/RCP45/tas_day_Ecuador_IPSL-CM5A-MR_rcp45_"
####periodo 2011-2030
pr=Process(preci)
data=pr.procesPeriod(2011,2030,var='temp',funcion=2)
data.to_csv(guar+"tmed_2011-2030rcp45.csv", sep=";", index=False, encoding="utf-8")
####periodo 2031-2050
data=pr.procesPeriod(2031,2050,var='temp',funcion=2)
data.to_csv(guar+"tmed_2031-2050rcp45.csv", sep=";", index=False, encoding="utf-8")
####periodo 2051-2070
data=pr.procesPeriod(2051,2070,var='temp',funcion=2)
data.to_csv(guar+"tmed_2051-2070rcp45.csv", sep=";", index=False, encoding="utf-8")
####Datos de temperatura minima con rcp 85
preci="/media/drosero/Darwin/Mensuales/TMed/RCP85/tas_day_Ecuador_IPSL-CM5A-MR_rcp85_"
####periodo 2011-2030
pr=Process(preci)
data=pr.procesPeriod(2011,2030,var='temp',funcion=2)
